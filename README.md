...
🚀 Features
	•	🔥 Fire Prediction Map
	•	Pixel-wise probability of fire occurrence
	•	🧠 CNN-based Model
	•	Lightweight and optimized for low-resource systems
	•	🌍 Geospatial Data Integration
	•	LULC + weather data used as features
	•	🔁 Fire Spread Simulation
	•	Cellular Automata model with time progression
	•	🎬 Animation Support
	•	Fire spread visualized over time (1, 2, 3, 6, 12 hours)
	•	📊 Confidence Map
	•	Highlights uncertainty in predictions
	•	🖥️ Streamlit UI
	•	Clean interface for demo and visualization
